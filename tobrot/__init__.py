...
logging.basicConfig(
    ...
    handlers=[
        RotatingFileHandler(
            "Torrentleech-Gdrive.txt", maxBytes=5000000000, backupCount=10
        ),
...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5583961779:AAEwUaBbCASqFOTMIba9pdZe6V5JlwsPlMw")
APP_ID = int(os.environ.get("APP_ID", "13689511"))
API_HASH = os.environ.get("API_HASH", "c4527c8e214ef2450e352ce3a24a7454"))
OWNER_ID = int(os.environ.get("OWNER_ID", "1301592091"))

# Get these values from my.telegram.org
# to store the channel ID who are authorized to use the bot
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "TZXhe2idA9c0NDM9").split()]
...
AUTH_CHANNEL.append(ddJYkxn12NdkOWI1)
